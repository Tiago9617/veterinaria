 ...
 * class construction.
 */
public class TextPrompt_1 extends JLabel implements FocusListener, DocumentListener {
	/**
	 * 
	 */
	...
	public TextPrompt_1(String text, JTextComponent component) {
		this(text, component, Show.ALWAYS);
	}

	public TextPrompt_1(String text, JTextComponent component, Show show) {
